...
calc_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case MEMORISER_DERNIER_RESULTAT:
		_xdr_argument = (xdrproc_t) xdr_int;
		_xdr_result = (xdrproc_t) xdr_void;
		local = (char *(*)(char *, struct svc_req *)) memoriser_dernier_resultat_1_svc;
		break;

	case EXTRAIRE_MEMOIRE:
		_xdr_argument = (xdrproc_t) xdr_int;
		_xdr_result = (xdrproc_t) xdr_long;
		local = (char *(*)(char *, struct svc_req *)) extraire_memoire_1_svc;
		break;
